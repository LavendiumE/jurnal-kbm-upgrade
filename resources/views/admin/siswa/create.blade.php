...
<div class="sm:ml-64 pt-20 px-6 pb-8">
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-3 mb-2">
            ...
            <a href="{{ route('admin.siswa.kelas', $kelasTerpilih->id) }}"
        ...
        <p class="text-sm text-gray-500 mt-1">
            Tambahkan siswa baru ke kelas {{ $kelasTerpilih->nama }}
        </p>
    ...
    <form
            ...
            <div>
                ...
                <select
                    ...
                    @foreach($kelas as $k)
                        ...
                        <option
                            value="{{ $k->id }}"
                            {{ $kelasTerpilih->id == $k->id ? 'selected' : '' }}>
        ...
        <div class="flex justify-end gap-3 mt-6">
            ...
            <a
                href="{{ route('admin.siswa.kelas', $kelasTerpilih->id) }}"
